...
variable "create_iam_role" {
  type        = bool
  description = "Whether to create IAM role and instance profile for ECS instances. Only required when using EC2 capacity providers (capacity_providers_ec2 or external_ec2_capacity_providers)."
  default     = true
}

variable "existing_iam_role_name" {
  type        = string
  description = "Name of existing IAM role to use when create_iam_role is false. Only required when using EC2 capacity providers."
  default     = null
