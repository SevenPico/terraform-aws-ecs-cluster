...
variable "descriptor_formats" {
  ...
  description = <<-EOT
    ...
    Label values are provided by variables of the same name in this module.
    For example, if `labels = ["namespace", "stage"]`, then the value of the
    `namespace` variable is passed first, and the value of the `stage` variable
    is passed second.
  EOT
}
